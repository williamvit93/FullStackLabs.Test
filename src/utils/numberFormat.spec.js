import {getCurrencyFormattedNumber, isInt, scrubFormatting, getFormattedNumber, formatValueMinimumThreeDigits} from './numberFormat';
...
describe('Number Formatter', () => {
  ...
  describe('formatValueMinimumThreeDigits', () => {
    it('returns 000 if passed 0', () => {
      expect(formatValueMinimumThreeDigits(0)).toEqual('000');
    });

    it('returns 056 string if passed 56', () => {
      expect(formatValueMinimumThreeDigits(56)).toEqual('056');
    });
  });
});
